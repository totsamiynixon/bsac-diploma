...
namespace WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await SendEmailConfirmation(user.Id, model.Email);
                    //await _signInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
                    return Content("Successfully registered. Please, confirm you email adress and sign in");
                }
                AddErrors(result);
            }
        ...
        private async Task SendEmailConfirmation(int userId, string email)
        {
            ...
            {
                Body = $"Click on the link to confirm your email: <a href='{callbackUrl}'>Confirm</a>",
